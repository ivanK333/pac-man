...
3. Откройте или установите docker
4. В корень проекта добавьте файл .env
```
 CLIENT_PORT=3000
 SERVER_PORT=3005
...
```
5. Запустите docker командой: `docker-compose up`
6. Откройте http://localhost:3005/
7. В конце использование очистите контайнеры командой: `docker system prune -af`
